...
dental_stats_1c<-read.csv("01_Hard_coded_model/dental_stats_1c.csv", skip=4)
dental_stats_2c<-read.csv("01_Hard_coded_model/dental_stats_2c.csv", skip=4)
dental_stats_5a<-read.csv("01_Hard_coded_model/dental_stats_5a.csv", skip=4)
dental_stats_6a<-read.csv("01_Hard_coded_model/dental_stats_6a.csv", skip=4)
pcr_2425<-read.csv("01_Hard_coded_model/PCR_2425.csv")

smt_pack<- read.csv("01_Hard_coded_model/SMT_pack.csv")%>%
...
uda_projection<- read.csv("01_Hard_coded_model/UDA_projection.csv", skip=2)[c(1, 14:25)]

hn_pat_dist<-read.csv("01_Hard_coded_model/HN_patients_distribution.csv",skip=1, col.names=c("Lab", "Pathway 1", "Pathway 2") )

input_var<-read.xlsx("01_Hard_coded_model/Input_for_testing.xlsx", sheet = "Assumptions", startRow = 1)
